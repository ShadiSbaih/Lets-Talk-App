...
const CallList = ({ type }: { type: 'ended' | 'upcoming' | 'recordings' }) => {
            ...
            calls.map((meeting: Call | CallRecording) => { // Map over calls
              return (
                <MeetingCard
                  ...
                  icon={
                    type === 'ended'
                      ? '/DesignAssets/previous.svg' // Icon for ended calls
                      : type === 'recordings'
                      ? '/DesignAssets/recordings2.svg' // Icon for recordings
                      : '/DesignAssets/upcoming.svg' // Icon for upcoming calls
                  }
                  title={
                  ...
                  buttonIcon1={type === 'recordings' ? '/DesignAssets/play.svg' : undefined} // Use play icon for recordings
    ...
    return (
        <Alert
          ...
          iconUrl='/DesignAssets/no-calls.svg' // Alert icon
        />
      );
